...
<head>
    ...
    <style type="text/css">
        ...
        body{
            background-image: url("../img/breaking_news_original_53371.jpg");
...
<body>
<h3 align="center"> Bienvenue sur la page des articles </h3>
...
<?php
    ...
    if(isset($tabNews)) {
        foreach ($tabNews as $new) {
            echo '<div class="col-md-6"><h2>' . $new->getTitle() . '</h2><p>' . $new->getDate() . '</p><p>' . $new->getDescription() . '</p><a href="'.$new->getAddress().'">La suite ici !</a></div></br>';
        }
